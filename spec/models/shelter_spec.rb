...
RSpec.describe Shelter, type: :model do
  ...
  before(:each) do
    ...
    @app_1 = Application.create!(name: 'Bobby Luly', street_address: '123 Sesame Street', city: 'Denver', state: 'CO', zip_code: 80123, description: 'Yes', status: 'Pending')
    @pet_app = PetApplication.create!(application: @app_1, pet: @pet_1)
  end
